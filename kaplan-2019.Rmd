...
Figure (@first): This is the first element
...
(@second) This is the second element
...
Here, I'm refering to (@second) and to Figure (@first).
...
Pboth <- 
  ...
  gf_pointrange(mean + lower + upper ~ 9.4, 
                data = Raw_stats_sector,  color = "pink", size = 1.5, alpha = 0.5) %>%
